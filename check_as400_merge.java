...
After Version 0.18.01 was Modified by Shao-Pin, Cheng since 2010/06/31
...
//			start=findToken(buffer,":",12)+1;
	...
	final static int WRKSYSSTS=0,WRKOUTQ=1,DSPMSG=2,DSPSBSD=3,DSPJOB=4,WRKACTJOB=5,CMDCLP=6,WRKDSKSTS=7,WRKASPBRM=8,WRKSYSACT=9,CHKJOBSTS=10,CMDLOGIN=11;
	//These constants are for the variables
	final static int CPU=0,DB=1,US=2,JOBS=3,MSG=4,OUTQ=5,SBS=6,DJOB=7,AJOBS=8,JOBSTS=9;
	final static int CPU=0,DB=1,US=2,JOBS=3,MSG=4,OUTQ=5,SBS=6,DJOB=7,AJOBS=8,DBFault=9,QCMN=10,DISK=11,ASP=12,CPUC=13;
